/**
 * The function countOddEven takes an array of integers as input and counts the number of odd and even
 * elements in the array.
 * 
 * @return The code does not return anything. It only prints the count of odd and even elements in the
 * array.
 */
//{ Driver Code Starts
